...
var __parent0=require('$model/UI2/system/components/justep/data/designer/setService'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cJzUNZv';
	this._flag_='b20644de9f11342c0c579af2fb535b33';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":false,"confirmRefresh":false,"defCols":{"action":{"define":"action","label":"Action","name":"action","relation":"action","type":"String"},"checked":{"define":"checked","label":"选择","name":"checked","relation":"checked","type":"Boolean"},"path":{"define":"path","label":"BAAS服务","name":"path","relation":"path","type":"String"},"table":{"define":"table","label":"表","name":"table","relation":"table","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"dataServiceCustomRefresh","onValueChanged":"dataServiceValueChanged"},"idColumn":"path","limit":-1,"xid":"dataService"});
